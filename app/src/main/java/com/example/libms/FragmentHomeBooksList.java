...
public class FragmentHomeBooksList extends Fragment {
    RecyclerView recyclerView;
    private int uid;
     private String URL_PRODUCTS = "http://"+ConstantValues.ipaddress+"/LibMS/getproductdata/";
    private List<ProductModel> productList;
    private List<ProductModel> productList2;
    RecyclerView_adapter_homepage adapter;
    private int noofloads = 0;
    public FragmentHomeBooksList(){
